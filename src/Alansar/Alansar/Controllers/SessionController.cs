...
namespace Alansar.Controllers
{
    ...
    public class SessionController : ControllerBase
    {
        ...
        {
            session.StartDate = DateTime.SpecifyKind(session.StartDate.Value, DateTimeKind.Utc).ToUniversalTime();
            session.EndDate = DateTime.SpecifyKind(session.EndDate.Value, DateTimeKind.Utc).ToUniversalTime();
